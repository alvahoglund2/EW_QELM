function charge_measurments(hamiltonian :: AbstractMatrix, ρ_R :: AbstractMatrix , t_eval, 
    d :: FermionBasis, d_main :: FermionBasis, dA_main :: FermionBasis, dB_main :: FermionBasis, 
    d_res :: FermionBasis, nbr_ent_states :: Integer, nbr_sep_states :: Integer, ent_state_types, p_min, fock_nbrs)
